				...
				<nav class="clearfix menu-container nav-desktop" role="navigation">
					<div>
						<ul id="nav"> 
							...
							<div class="dropdown">
									<a href="#" data-toggle="dropdown" role="button" id="dropdownMenuLink" class="btn btn-secondary dropdown-toggle spe-fintech" aria-haspopup="true" aria-expanded="false">Programme Action</a>
			...
			<div class="container-fluid" >
			    <div class="clearfix middle-container">
			        <div class="col-md-5 texte-slide2-sm middle-text">
			        	...
			        	<p>Quelle que soit votre ambition : démarrer votre side-project, devenir freelance ou monter votre entreprise, ce programme vous aide à trouver les idées, l'énergie, la stratégie et moyens pour y arriver.</p>
			        </div>
