...
<script>
    setTimeout(function() {
      window.location.href = "https://www.wake-up.io/wp-content/themes/t-sixteen-child-theme/documents/RIB-WAKE-UP.pdf";
    }, 2000);
</script>
                ...
                <div class="clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 slide1-lineup">
                        ...
                        <div class="bouton-slide-1">
                            <a href="https://www.wake-up.io/wp-content/themes/t-sixteen-child-theme/documents/RIB-WAKE-UP.pdf">
                                <button class="btn btnred">Accéder au RIB</button>
                            </a>
                        </div>
                    </div>
                </div>
