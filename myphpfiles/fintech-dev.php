			    ...
			    <div class="cta-container">
			    	...
			    	<h2>Rejoignez le premier<br> programme Fintech de France</h2>
			   		<div>
			   			...
			   			if( $iPod || $iPhone ){
			   			    ?>
			   				<a id="vu-inscrire-1" class="cta-slide-A" href='<?php echo bloginfo('stylesheet_directory').'/documents/🎓 WAKE UP • Inscriptions au programme Fintech.ics';?>'>
				...
				<div class="clearfix bg-chart-stats">
					<div class="col-sm-3 trois-colonnes col-une">
						...
						<div class="trois-lignes ligne-trois">
							<h3>40 %</h3>
							<h4>évoluent en interne vers la stratégie digitale</h4>
						</div>
					</div>
			...
			<div class="container-fluid">
				...
				<div class="row-candidature">
				    ...
				    <?php
			   			...
			   			if( $iPod || $iPhone ){
			   			    ?>
			   				<a id="vu-inscrire-2" class="cta-slide-A" href='<?php echo bloginfo('stylesheet_directory').'/documents/🎓 WAKE UP • Inscriptions au programme Fintech.ics';?>'>
			   				Inscriptions le 15 janvier
							</a>
							<?php
			   			}else if($iPad){
