...
var countDownDate = new Date("April 19, 2019 20:00:00").getTime();
...
<div class="bottomMenu">
	<p class="countdown-cta">
		...
		<p class="tohide-2">Les inscriptions se terminent dans :&nbsp</p><!--<p class="chiffres" id="jours"></p> <p class="tohide">j &nbsp</p>--><p class="chiffres" id="heures"></p> <p class="tohide">h</p> <p class="chiffres" id="minutes"></p> <p class="tohide">min</p> <p class="chiffres" id="secondes"></p> <p class="tohide">s</p> <p class="countdown-cta">  
			<?php 
			    if(isset($_GET['exclu']))
			    {
			    	?>
			    	<a id="vu-inscrire-3" href="https://www.wake-up.io/inscription-programme-fintech?exclu">Inscrivez-vous maintenant</a>
			    	<?php
			    }
			    else {
			    	?>
			    	<a id="vu-inscrire-3" href="https://www.wake-up.io/inscription-programme-fintech/">Inscrivez-vous maintenant</a>
			    	<?php
			    }
			?>
		</p>
			    	...
			    	<h2>Vivez la Fintech de l'intérieur</br>et faites évoluer votre carrière.</h2>
			   		<div>
			   			<?php 
			   			    ...
			   			    {
			   			    	?>
			   			    	<a id="vu-inscrire-1" class="cta-slide-A" href="https://www.wake-up.io/inscription-programme-fintech?exclu">Je m'inscris !</a>
			   			    	<?php
			   			    }
			   			    else {
			   			    	?>
			   			    	<a id="vu-inscrire-1" class="cta-slide-A" href="https://www.wake-up.io/inscription-programme-fintech">Je m'inscris !</a>
			   			    	<?php
			   			    }
			   			?>
		...
		background-image: url('<?php echo bloginfo('stylesheet_directory').'/images/bg-photo.png';?>'); background-repeat:no-repeat; background-size: cover; background-position: top; ">
			<div class="container-fluid">
			    ...
			    <div class="row-program">
			    	<a id="vu-programme" target="_blank" href="https://www.wake-up.io/wp-content/themes/t-sixteen-child-theme/documents/PROGRAMME-Promo-9.pdf">
				        <div id="vu-programme" class="btn cta-program">
				        	<h3 id="vu-programme" >Voir le programme détaillé</h3>
				        </div>
			        </a>
			    </div>
		...
		<section class="slide_temoignages" id="temoignages-fintech">
			<div class="container-fluid">
			    ...
			    <div class="row footer-temoignages">
			        <div class="col-md-8 col-md-offset-2 ">
			        	<a id="vu-temoignages" class="plus-temoignages" href="https://www.facebook.com/pg/joinwakeup/reviews/?ref=page_internal" target="_blank">
		...
		background-image: url('<?php echo bloginfo('stylesheet_directory').'/images/FINTECH/bg-stats.jpg';?>'); background-repeat:no-repeat; background-size: cover; background-position: top; ">
			<div class="container-fluid">
				<div class="clearfix">
					...
					<div class="col-sm-8 col-sm-offset-2">
						<p>
							Ce programme vous montre que les opportunités de carrière dans la finance sont bien plus larges que ne vous pouviez l’imaginer. Nos alumni mettent leur talent créatif au service de la stratégie digitale pour faire bouger les lignes ou entreprendre :
						</p>
					</div>
				</div>
			</div>
		...
		<section id="slide6" class="slide6" style="
			...
			<div class="container-fluid">
				<div class="row header-slide6">
					<div class="col-md-8 col-md-offset-2">
						<h2>Faites partie de la promotion 2019</h2>
						<h3>
							<strong><a id="vu-planning" target="_blank" href="https://www.wake-up.io/wp-content/themes/t-sixteen-child-theme/documents/PROGRAMME-Promo-9.pdf">Voir le planning du 22 mai au 17 juin.</a></strong>
						</h3>
						<h3>
				...
				<div class="row slide6-prix">
					<div class="col-md-8 col-md-offset-2">
						...
						<?php 
						    ...
						    {
						    	?>
						    	<h2><span style="text-decoration: line-through;">2&nbsp;790€ TTC</span> / 2&nbsp;290€ TTC</h2>
						    	<?php
						    }
						    else {
						    	?>
				...
				<div class="row-candidature">
					<?php 
					    ...
					    {
					    	?>
					    	<a id="vu-inscrire-2" onclick='boutonpostulez()' href="https://www.wake-up.io/inscription-programme-fintech?exclu">Je m'inscris !</a>
					    	<?php
					    }
					    else {
					    	?>
					    	<a id="vu-inscrire-2" onclick='boutonpostulez()' href="https://www.wake-up.io/inscription-programme-fintech/">Je m'inscris !</a>
					    	<?php
					    }
					?>
...
<script type="text/javascript">
	$(function () {
	  count = 0;
	  wordsArray = ["boîte", "équipe", "carrière"];
