<div id="primary" class="content-area">
    <main id="main" class="site-main page-cours-audio" role="main">
                                    ...
                                    if(isset($_GET['code']))
                                        {
                                            ...
                                            ?>
                                            <a href="#">
                                                <button class="btn btnred">Rdv demain à 19h !</button>
                                            </a>
                                            <?php
                                        }
                                }
        ...
        <section class="slide slide7" >
            <div class="cadre-prix">
                <?php 
                    ...
                    ?>
                         <h2 style="font-size: 2em;">Rejoignez la promo de février !</h2>
                         <h3>Vente privée : en plus du cours audio classique, vous aurez accès à un coaching collectif en ligne de 2h</h3>
                         ...
                         <div class="bouton-slide-7">
                             <?php 
                                 if(isset($_GET['code']))
                                 {
                                     ...
                                     ?>
                                     <a href="#">
                                         <button class="btn">Inscriptions demain !</button>
                                     </a>
                                     <?php
                                 }
                             ?>
        ...
        <section id="slide-G" class="slide-G" style="background-color: #ffffff; padding-top: 1em;">
            <div class="container-fluid">
                <div>
