<link href="<?php echo get_stylesheet_directory_uri(); ?>/css/style-podcast-launch.css?v0" rel="stylesheet">
    ...
    <main id="main" class="site-main page-cours-audio" role="main">
            ...
            <div class="container-fluid">
                ...
                <div class="clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 slide1-lineup">
                        ...
                        <h1><?php echo $_GET['user_name']; ?>, trouvez un métier<br> adapté à votre personnalité !</h1>

                        <h2>Le cours audio pour vous aider à trouver un job qui a du sens.</h2>

                       
                        <div class="bouton-slide-1">
                            <a href="#infos-sur-prix">
                    ...
                    <div class="col-md-6  col-lg-6 col-xs-12  col-md-push-6  dessus-episodes ">
                        <div class="container-slideright">
                            ...
                            <?php 
                                ...
                                {
                                ?>
                                    <h2><span class="white">Un cours audio en </span><span class="red">8&nbsp;épisodes </span>pour aider vos proches à naviguer dans leur changement de carrière</h2>
                                <?php
                                }

                                else {
                                ?>
                                     <h2><span class="white">Un cours audio en </span><span class="red">8&nbsp;épisodes </span>pour vous aider à naviguer dans votre changement de carrière</h2>
                                <?php
                                }
                             ?>
            ...
            <div class="container-fluid ">
                ...
                <div class="col-md-6  col-lg-6 col-xs-12  col-sm-12  ">
                    ...
                    <?php 
                        ...
                        {
                        ?>
                            <h2>Les métiers qui <span class="jaune">LEUR</span> correspondent...</h2>
                            ...
                            <p>Le cours audio est livré avec une <span class="jaune">liste des métiers qu'ils pourraient exercer.</span>
                            </p>

                            <p>Ce sont tous les métiers <span class="jaune">où ils peuvent utiliser leur talent d’or</span> décrit les résultats du <a href="<?php echo site_url();?>/boussole">test de personnalité Boussole (gratuit)</a> !</p>

                            <p><span class="jaune">Cette liste 100 % personnalisée</span> est issue de nos recherches et d’une analyse de plus de 400 métiers.</p>
                        <?php
                        }
                        ...
                        ?>
                             ...
                             <p>Le cours audio est livré avec une <span class="jaune">liste des métiers que vous pourriez exercer.</span>
                             </p>
        ...
        <section class="slide slide3" style="    background-position: center ; background: url('<?php echo bloginfo('stylesheet_directory') . '/images/podcast/bg_whywego.jpg'; ?>') no-repeat ; background-size: cover; background-position: right;">
            <div class="col-md-8 col-lg-8 col-xs-12 col-sm-12 bundle-temoignages">
                <h2>La raison d’être de ce cours ?</h2>
                <h2>Elle est ici :</h2>
                ...
                <?php 
                    ...
                    ?>
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="col-md-4 blocicon">
                                ...
                                <p>De l’inspiration pour faire le grand saut</p>
                            </div>
                            <div class="col-md-4 blocicon">
                                <img src="<?php echo bloginfo('stylesheet_directory') . '/images/podcast/icon_fusee.svg'; ?>"/>
                                <p>Un coup de boost parce qu'ils ne sont pas seuls</p>
                            </div>
                            <div class="col-md-4 blocicon">
                                <img src="<?php echo bloginfo('stylesheet_directory') . '/images/podcast/icon_flacon.svg'; ?>"/>
                                <p>Des éléments factuels sur la science et la philosophie</p>
                            </div>
                        </div>
                    <?php
                    }
                    ...
                    ?>
                         ...
                         <div class="col-md-12 ">
                             ...
                             <div class="col-md-4 blocicon">
                                 <img src="<?php echo bloginfo('stylesheet_directory') . '/images/podcast/icon_carre.svg'; ?>"/>
                                 <p>Une meilleure compréhension de votre psychologie</p>
                             </div>
                             <div class="col-md-4 blocicon">
                                 <img src="<?php echo bloginfo('stylesheet_directory') . '/images/podcast/icon_cle.svg'; ?>"/>
                                 <p>Des clés pour transformer votre potentiel en force</p>
                             </div>
                             <div class="col-md-4 blocicon">
                                 <img src="<?php echo bloginfo('stylesheet_directory') . '/images/podcast/icon_outil.svg'; ?>"/>
                                 <p>Une stratégie pour sortir des schémas classiques de la recherche d’emploi</p>
                         ...
                         <div class="col-md-12 ">
                             ...
                             <div class="col-md-4 blocicon">
                                 <img src="<?php echo bloginfo('stylesheet_directory') . '/images/podcast/icon_fusee.svg'; ?>"/>
                                 <p>Un coup de boost parce que vous n’êtes pas seul•e</p>
                             </div>
                             <div class="col-md-4 blocicon">
                                 <img src="<?php echo bloginfo('stylesheet_directory') . '/images/podcast/icon_flacon.svg'; ?>"/>
                                 <p>Des éléments factuels sur la science et la philosophie</p>
        ...
        <section class="slide slide5">
            <div class="container-fluid ">
                ...
                <div class="col-md-6  col-lg-6 col-xs-12  col-sm-12  text_bloc">
                    ...
                    <strong>
                        Anaïs a mis deux ans pour changer de voie et trouver un métier qui colle enfin avec sa personnalité. Ce cours s’inspire de son histoire.
                    </strong>
        ...
        <!-- **** SLIDE 5 *** -->
        <!--******************-->
        <?php include('wp-content/themes/t-sixteen-child-theme/myphpfiles/podcast-teasing-video.php'); ?>
        <!--******************-->
        <!-- **** SLIDE 7 *** -->
        <section id="infos-sur-prix" class="slide slide7" >
            <div class="cadre-prix">

                         <h3>En moyenne 3h de coaching personnel coûtent</h3> 
                         <h2 style="text-decoration: line-through;">450 €</h2>
                         <h3 style="margin-bottom: 1em;"><?php echo $_GET['user_name']; ?>, avec ce cours audio recevez :</h3>
                         <p>⚡ 4h de conseils, exercices & anecdotes</p>
                         <p>⚡ Une liste de métiers 100% personnalisée</p>
                         <p>⚡ 2h de coaching collectif en ligne</p>
                         <p>⚡ L'accès à un groupe privé d'entraide</p> 
                         <p>⚡ Le tout, à vie.</p>   
                            
                        </h3>
                         <h2 class="prix-podcast" style="color:#03e8fc; margin-top: 1em;">pour seulement 79&nbsp€</h2>

                         <div class="bouton-slide-7">
                            <?php if(isset($_GET['utm_content'])) { ?>
                                <a href="https://boussole.wake-up.io/podcast/monpodcast/inscription?venteprivee&code=on"><button class="btn">Je m'inscris !</button></a>
                            <?php } else { ?>
                                <a href="https://boussole.wake-up.io/podcast/monpodcast/inscription?venteprivee"><button class="btn">Je m'inscris !</button></a>
                            <?php } ?>
                         </div>
        ...
        <section id="prix-comparatif" class="prix-comparatif">
            <div class="container-fluid">
                <div class="clearfix">

                    <h2 class="titre-comparatif"><?php echo $_GET['user_name']; ?>, profitez de cette vente privée jusqu'à dimanche 16h :</h2>

                    <div class="col-sm-6 cadre-prix-g">
                        <div class="cadre-prix-comparatif spe-cadre-g">
                            <h2>Offre normale</h2>
                            <h3>79 €</h3>
                            <p>⚡ 4h de conseils, exercices & anecdotes</p>
                            <p>⚡ Une liste de métiers 100% personnalisée</p>
                            <p style="text-decoration: line-through; color:rgb(255, 255, 255,0.5)">2h de coaching collectif en ligne</p>
                            <p style="text-decoration: line-through; color:rgb(255, 255, 255,0.5)">L'accès à un groupe privé d'entraide</p>
                            <a href="#prix-comparatif">
                                <button class="btn btn-hidden">.</button>
                            </a>
                        </div>
                        
                    </div>
                    <div class="col-sm-6 cadre-prix-d">
                        <div class="cadre-prix-comparatif spe-cadre-d">
                            <h2>Vente privée</h2>
                            <h3>79 €</h3>
                            <p>⚡ 4h de conseils, exercices & anecdotes</p>
                            <p>⚡ Une liste de métiers 100% personnalisée</p>
