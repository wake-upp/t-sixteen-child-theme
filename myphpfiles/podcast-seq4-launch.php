    ...
    <main id="main" class="site-main page-cours-audio" role="main">
                            ...
                            <?php
                                if(isset($_GET['code']))
                                    ...
                                    ?>  
                                        ...
                                        <a href="mailto:podcast@wake-up.io?subject=Liste%20d'attente%20-%20Programme%20audio&body=Bonjour%20l'%C3%A9quipe%20WAKE%20UP%2C%0A%0AJ'aimerais%20figurer%20sur%20la%20liste%20d'attente%20pour%20les%20inscriptions%20de%20mars.%0A%0AMerci%20!" >
                                            <button class="btn btnred">Inscriptions du 16 au 18 mars</button>
                                        </a>
        ...
        <section class="slide slide7" >
            <div class="cadre-prix">
                ...
                <div class="bouton-slide-7">
                    <?php 
                        if(isset($_GET['code']))
                        {
                            ...
                            ?>
                            <a href="mailto:podcast@wake-up.io?subject=Liste%20d'attente%20-%20Programme%20audio&body=Bonjour%20l'%C3%A9quipe%20WAKE%20UP%2C%0A%0AJ'aimerais%20figurer%20sur%20la%20liste%20d'attente%20pour%20les%20inscriptions%20de%20mars.%0A%0AMerci%20!">
                                <button class="btn">Inscriptions du 16 au 18 mars</button>
                            </a>
                            <?php
                        }
                    ?>
                ...
                <a class="cta-boussole" target="_blank" href="mailto:podcast@wake-up.io?subject=Liste%20d'attente%20-%20Programme%20audio&body=Bonjour%20l'%C3%A9quipe%20WAKE%20UP%2C%0A%0AJ'aimerais%20figurer%20sur%20la%20liste%20d'attente%20pour%20les%20inscriptions%20de%20mars.%0A%0AMerci%20!">S'inscrire sur la liste d'attente</a>
