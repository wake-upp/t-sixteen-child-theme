...
var countDownDate = new Date("January 15, 2020 10:00:00").getTime();
...
<div class="bottomMenu">
	<p class="countdown-cta">
		...
		<p class="tohide-2">Fin des inscriptions mardi à 21h.</p> <!--<p class="chiffres" id="jours"></p> <p class="tohide-2" style="display: inline-block;"> jours </p> <p class="chiffres" id="heures"></p> <p class="tohide">h</p> <p class="chiffres" id="minutes"></p> <p class="tohide">min</p> <p class="chiffres" id="secondes"></p> <p class="tohide">s</p> <p class="countdown-cta">  --><a id="vu-inscrire-3" href="https://www.wake-up.io/inscription-programme-fintech/">S'inscrire maintenant</a></p>
	</p>
...
<br><span style="color:#000;">les innovateurs.</span></h2>
				        	...
				        	<p style="font-family: 'Raleway-Bold';">
					        	Vous êtes curieux et sensible au monde qui bouge ? Vous avez envie de donner plus de sens à la finance ?
				        	</p>
				        	<p>
				        		Ce programme est fait pour vous transmettre l’état d’esprit des entrepreneurs et des acteurs qui changent la donne. Ils vous montreront que tout est possible et que vos idées nouvelles peuvent avoir un impact concret dans votre métier.
				        	</p>
			        	</div>
		...
		<section id="slide6" class="slide6" style="
			...
			<div class="container-fluid">
				...
				<div class="row-candidature">
				   ...
				   <a id="vu-inscrire-2" class="cta-slide-A" href="https://www.wake-up.io/inscription-programme-fintech/">
			   				Je m'inscris !
							</a>
				</div>	
