...
.slide1 .bouton-slide-1 .btn:hover , .slide1 .bouton-slide-1 .btn:focus , .slide1 .bouton-slide-1 .btn:active {
    background-color: #ff0055;
    cursor: text;
    border-radius: 0px;
}
.slide1 .bouton-slide-1 .btn {
    cursor: text;
    border-radius: 0px;
} 

.bouton-slide-7 .btn:hover , .bouton-slide-7 .btn:active , .bouton-slide-7 .btn:focus {
...
var countDownDate = new Date("August 5, 2019 10:00:00").getTime();
...
<div class="bottomMenu">
    <p class="countdown-cta">
        ...
        <p class="tohide-2">Les inscriptions ouvrent dans :&nbsp</p><!--<p class="chiffres" id="jours"></p> <p class="tohide">jours &nbsp</p>--><p class="chiffres" id="heures"></p> <p class="tohide">h &nbsp</p><p class="chiffres" id="minutes"></p> <p class="tohide">min</p> <p class="chiffres" id="secondes"></p><!-- <p class="tohide">s <p class="countdown-cta"> <a id="vu-inscrire-3" href="#">Inscrivez-vous maintenant</a> </p></p>-->
    </p>
    ...
    <main id="main" class="site-main page-cours-audio" role="main">
                ...
                <div class="clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 slide1-lineup">
                        ...
                        <div class="bouton-slide-1">
                            ...
                            <a target="_blank" href="http://www.google.com/calendar/event?action=TEMPLATE&dates=20190805T090000Z%2F20190809T180000Z&text=WAKE%20UP%20%F0%9F%8E%93%20Ouverture%20des%20inscriptions&location=&details=Ouverture%20des%20inscriptions%20au%20programme%20audio%20%F0%9F%91%89%20https%3A%2F%2Fwww.wake-up.io%2Fcours-audio%2F%3Fcal%0A%0AUn%20accompagnement%20complet%20pour%20m'aider%20%C3%A0%20pr%C3%A9parer%20mon%20changement%20de%20carri%C3%A8re.%20%F0%9F%91%8C%0A%0A100%20places%20disponibles%20%E2%80%A2%2079%E2%82%AC">
                                <button class="btn btnred">Inscription du 5 au 9 août</button>
                            </a>
        ...
        <section class="slide slide7" >
            <div class="cadre-prix">
                         ...
                         <div class="bouton-slide-7">
                            ...
                            <a target="_blank" href="http://www.google.com/calendar/event?action=TEMPLATE&dates=20190805T090000Z%2F20190809T180000Z&text=WAKE%20UP%20%F0%9F%8E%93%20Ouverture%20des%20inscriptions&location=&details=Ouverture%20des%20inscriptions%20au%20programme%20audio%20%F0%9F%91%89%20https%3A%2F%2Fwww.wake-up.io%2Fcours-audio%2F%3Fcal%0A%0AUn%20accompagnement%20complet%20pour%20m'aider%20%C3%A0%20pr%C3%A9parer%20mon%20changement%20de%20carri%C3%A8re.%20%F0%9F%91%8C%0A%0A100%20places%20disponibles%20%E2%80%A2%2079%E2%82%AC" >
                                <button class="btn">Inscription du 5 au 9 août</button>
                            </a>
        ...
        <section id="faq" class="slide-faq">
            <ul class="faq">
                ...
                <?php include('wp-content/themes/t-sixteen-child-theme/myphpfiles/questions-faq.php');
                     ?>
            </ul>
        </section>
