...
<?php include('wp-content/themes/t-sixteen-child-theme/myphpfiles/countdown.php') ?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 slide1-lineup">
                        ...
                        <div class="audio-intro">
                            ...
                            <p>Écouter l'intro</p>
                                 ...
                                 <h1><?php echo $_GET['usr_nm']; ?>, trouvez un métier<br> adapté à votre personnalité !</h1>
                        ...
                        <div class="bouton-slide-1">
                            ...
                            <a href="https://boussole.wake-up.io/cours-audio/monpodcast/inscription?seq3insc">
            ...
            <div class="col-md-8 col-lg-8 col-xs-12 col-sm-12 bundle-temoignages">
                ...
                <div class="col-md-12  col-lg-12 col-xs-12  col-sm-12">
                    <div class="col-md-6  col-lg-6 col-xs-12  col-sm-12 ">
                        ...
                        <div class="triangle-isosceles left"><p>J'ai dévoré les 4 premiers épisodes en une après midi. J'ai retrouvé tout ce que j'attendais d'un programme audio : un format podcast pratique à écouter, une voix captivante (celle d'Anaïs), un contenu créatif mélangeant autobiographies, références philosophiques, exercices pratiques et questionnements psychologiques.
                            </p>
                            <a>Sabrine</a>
                        </div>
                    </div>
