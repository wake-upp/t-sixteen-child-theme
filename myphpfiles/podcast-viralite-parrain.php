...
var countDownDate = new Date("March 18, 2019 10:00:00").getTime();
...
<!--<div class="bottomMenu">
    ...
    <p>Les inscriptions ouvrent dans</p>  <p class="chiffres" id="hours"></p> h <p class="chiffres" id="minutes"></p> m <p class="chiffres" id="secondes"></p>
</div>-->
                ...
                <div class="clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 slide1-lineup">
                        ...
                        <?php 
                            ...
                            {
                            ?>
                                <h1>Carte cadeau<br>pour un job épanouissant !</h1>
                            <?php
                            }
                        ...
                        <?php 
                            ...
                            {
                            ?>
                                <h2>Le cours audio pour aider vos proches à trouver un job qui a du sens.</h2>
                            <?php
                            }

                            else {
                            ?>
                                 <h2>Après Boussole, voici le cours audio qui vous aide à trouver un job qui a du sens.</h2>
                            <?php
                            }
                         ?>
                        ...
                        <div class="bouton-slide-1">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="https://boussole.wake-up.io/cours-audio/monpodcast/cadeau">
                                        <button class="btn btnred">Offrir le cours</button>
                                    </a>
                                    <?php
                                }
                    ...
                    <div class="col-md-6  col-lg-6 col-xs-12  col-md-push-6  dessus-episodes ">
                        <div class="container-slideright">
                            ...
                            <?php 
                                ...
                                {
                                ?>
                                    <h2><span class="white">Un programme audio en </span><span class="red">8&nbsp;épisodes </span>pour aider vos proches à naviguer dans leur changement de carrière</h2>
                                <?php
                                }

                                else {
                                ?>
                                     <h2><span class="white">Un programme audio en </span><span class="red">8&nbsp;épisodes </span>pour vous aider à naviguer dans votre changement de carrière</h2>
                                <?php
                                }
                             ?>
                ...
                <div class="col-md-6  col-lg-6 col-xs-12  col-sm-12  ">
                    ...
                    <?php 
                        ...
                        ?>
                            ...
                            <p><span class="jaune">Cette liste 100 % personnalisée</span> à partir de vos résultats Boussole, est issue de nos recherches et d’une analyse de plus de 400 métiers.</p>
                        <?php
                        }
                        ...
                        ?>
                             ...
                             <p><span class="jaune">Cette liste 100 % personnalisée</span> à partir de vos résultats au test Boussole, est issue de nos recherches et d’une analyse de plus de 400 métiers.</p>
                        <?php
                        }
                     ?>
            ...
            <div class="cadre-prix">
                <?php 
                    ...
                    ?>
                        ...
                        <h3>Avec ce cours audio, offrez à vos proches plus de 3h de conseils et une liste de métiers 100% personnalisée</h3>
                        <h2 class="prix-podcast" style="color:#03e8fc;">pour seulement 59&nbsp€</h2>

                        <div class="bouton-slide-7">

                            <a href="https://boussole.wake-up.io/cours-audio/monpodcast/cadeau">
                                <button class="btn">J'offre le cours !</button>
                            </a>          
                    ...
                    ?>
                         <h3>En moyenne 3h de coaching personnel coûtent</h3>
                         <h2 style="text-decoration: line-through;">450 €</h2>
                         <h3>Avec ce cours audio, recevez plus de 3h de conseils et une liste de métiers 100% personnalisée</h3>
